...
<div align="center">
  ...
  <h3 align="center">RSSB CHAT BOT</h3>

  <p align="center">
    A Conversational chatbot to server information related to RURA!
    <br />
...
1. Clone the repo
   ```sh
   git clone https://github.com/VUGANEZAPATRICE/resto-chatbot.git
   ```
...
After running the gunicorn command open your browser at http://127.0.0.1/5000 to interact with the bot.
...
Your Name - [@linkedin](https://www.linkedin.com/in/patrice-vuganeza-2238b7a6/) - pvuganeza@gmail.com
